    ...
    return (
        <div>
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                    ...
                                    <text x="110" y="150" fill='white'>{cart.reduce((acc, item)=>{return acc+=item.quantity},0)}</text>
            ...
            {!showCart ? (
                ...
                <CartItem addedToCart={addedToCart} onContinueShopping={handleContinueShopping} />
            )}
        </div>
    );
}
